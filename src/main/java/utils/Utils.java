...
public class Utils {
	...
	public static String buttonName(WebElement element) {
		String nameCamelCase = element.getAttribute("id");

	    // Si no se encuentra el atributo "id", intenta obtener el atributo "name"
	    if (nameCamelCase == null || nameCamelCase.isEmpty()) {
	        nameCamelCase = element.getAttribute("name");
	    }
